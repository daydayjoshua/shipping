...
<form action="view.php" method="post" name="addtrack">
  <table width="400" border="0" align="center" cellpadding="0" cellspacing="3">
    <tr>
      ...
      <td width="53%"><label>
        <input name="num" type="text" id="num" size="25">
      </label></td>
    </tr>
    <tr>
      <td><span class="style13">Ship date :</span></td>
      <td><input name="shipdate" type="text" id="shipdate" value="yyyy-mm-dd" size="25"></td>
    </tr>
    <tr>
      <td><span class="style13">Estimated Date for Delivery</span></td>
      <td><input name="estdate" type="text" id="estdate" value="yyyy-mm-dd" size="25"></td>
    </tr>
    <tr>
      <td><span class="style13">Shipment type</span>:</td>
      <td><input name="shiptype" type="text" id="shiptype" size="25"></td>
    </tr>
    <tr>
      <td><span class="style13">Content:</span></td>
      <td><input name="content" type="text" id="content" size="25"></td>
    </tr>
    <tr>
      <td><span class="style13">Receiver Name:</span></td>
      <td><input name="recname" type="text" id="recname" size="25"></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td><input name="tele" type="text" id="tele" size="25"></td>
    </tr>
    <tr>
    ...
    <tr>
      <td>&nbsp;</td>
      <td><label>
        <input name="addnumbtn" type="submit" id="addnumbtn" onclick="MM_validateForm('num','','R','shipdate','','R','estdate','','R','shiptype','','R','content','','R','recname','','R','tele','','R','status','','R','address','','R');return document.MM_returnValue" value="Add Number">
      </label></td>
    </tr>
  </table>
</form>
...
require_once('connection/conn.php');
	 ...
	 $enter = mysql_query("INSERT INTO tracking SET 
	 num='$num',
	 ship_date='$shipdate',
	 ...
	 echo("<center> New Number Added successful </center>");
	 }
