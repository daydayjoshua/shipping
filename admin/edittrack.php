<?php
				  ...
				  $addadmin = mysql_query("select * from tracking where id = '$id'");
				if(!$addadmin){
...
<form action="view.php" method="post" name="addtrack">
  <table width="400" border="0" align="center" cellpadding="0" cellspacing="3">
    ...
    <tr>
      ...
      <td width="53%"><label>
        <input name="num" type="text" id="num" size="25" value="<?php echo $num;?>">
      </label></td>
    </tr>
    <tr>
      <td><span class="style13">Ship date :</span></td>
      <td><input name="shipdate" type="text" id="shipdate" size="25" value="<?php echo $shipdat;?>"></td>
    </tr>
    <tr>
      <td><span class="style13">Estimated Date for Delivery</span></td>
      <td><input name="estdate" type="text" id="estdate" size="25" value="<?php echo $estimate_dat;?>"></td>
    </tr>
    <tr>
      <td><span class="style13">Shipment type</span>:</td>
      <td><input name="shiptype" type="text" id="shiptype" size="25" value="<?php echo $ship_type;?>"></td>
    </tr>
    <tr>
      <td><span class="style13">Content:</span></td>
      <td><input name="content" type="text" id="content" size="25" value="<?php echo $content;?>"></td>
    </tr>
    <tr>
      <td><span class="style13">Receiver Name:</span></td>
      <td><input name="recname" type="text" id="recname" size="25" value="<?php echo $receive;?>"></td>
    </tr>
    <tr>
      <td valign="top"><span class="style13">Receiver Address:</span></td>
      <td><label>
        <textarea name="address" rows="4" id="address"><?php echo $address;?></textarea>
      </label></td>
    </tr>
    <tr>
      <td><span class="style13">Country:</span></td>
      <td><span class="tablestype">
        <select name="country" class="SelectGender" id="country">
    ...
    <tr>
      ...
      <td><input name="tele" type="text" id="tele" size="25" value="<?php echo $phone;?>"></td>
    </tr>
    <tr>
      <td><span class="style13">Status:</span></td>
      <td><input name="status" type="text" id="status" size="25" value="<?php echo $status;?>"></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
      <td><label>
        <input name="updatebtn" type="submit" id="updatebtn" value="Update">
      </label></td>
    </tr>
  </table>
</form>					
